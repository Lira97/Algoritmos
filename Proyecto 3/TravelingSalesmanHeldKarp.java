...
public class TravelingSalesmanHeldKarp {
	...
	public static void calculardistacias()throws FileNotFoundException 
			{
				 int V, E;
				double x1,y1,x2,y2,x,y;
				Scanner in = new Scanner(new File("P4tsp25.txt"));
				...
				TravelingSalesmanHeldKarp graph = new TravelingSalesmanHeldKarp();
